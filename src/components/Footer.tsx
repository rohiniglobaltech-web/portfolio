...
const socialLinks = [
  ...
  { name: "Email", icon: Mail, href: "mailto:rohinihatti713@gmail.com" },
];
    ...
    <footer className="bg-muted/30 border-t">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">
              Portfolio
            </h3>
        ...
        <div className="border-t pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm text-muted-foreground flex items-center gap-1">
            Made with <Heart className="h-4 w-4 fill-red-500 text-red-500" /> by a passionate developer
          </p>
        </div>
      </div>
    </footer>
